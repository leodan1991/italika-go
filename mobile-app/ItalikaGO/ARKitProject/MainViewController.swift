...
class MainViewController: UIViewController {
    ...
    @IBAction func pressShare(_ sender: UIBarButtonItem) {
        
        // image to share
        let image = UIImage(named: "italikaGO2")
        
        // set up activity view controller
        let imageToShare = [ image! ]
        let activityViewController = UIActivityViewController(activityItems: imageToShare, applicationActivities: nil)
        activityViewController.popoverPresentationController?.sourceView = self.addObjectButton // so that iPads won't crash
...
extension MainViewController {
    ...
    func resetVirtualObject() {
        ...
        //addObjectButton.setImage(#imageLiteral(resourceName: "logo_italika_icono"), for: [])
        //addObjectButton.setImage(#imageLiteral(resourceName: "logo_italika_icono"), for: [.highlighted])
    }
